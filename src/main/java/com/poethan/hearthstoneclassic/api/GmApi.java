...
public class GmApi {
    ...
    @PostMapping("/ivt")
    public EzRpcResponse<Map<String, Object>> invite(String fromUserName, String userName, Long deckId) {
        ...
        IApiCombatScene combatScene = combatLogic.init(fromUserName, userName, deckId);
    ...
    @PostMapping("/acpt")
    public EzRpcResponse<Map<String, Object>> accept(String userName, String gameId, Long deckId) {
        CombatScene scene = combatLogic.getCombatSceneById(gameId);
        if (!userName.equals(scene.getUserName2())) {
            return EzRpcResponse.ERROR(1001);
        }
        combatLogic.openWithAccept(gameId, deckId);
        return EzRpcResponse.OK(ImmutableMap.of("gameId", gameId));
    }

    @PostMapping("/rf")
    public EzRpcResponse<Boolean> refuse(String gameId) {
